...
CONTEXT_LEN = int(os.environ.get("MAX_CONTEXT_TOKENS", "16384")) # 16k Contexto Rápido Seguro (Zero-Spill VRAM)
            ...
            while True:
                ...
                if not chunk.get("done", False):
                    ...
                    if "</think>" in text_delta:
                        ...
                        if think_part:
                            delta_payload = {"reasoning_content": think_part}
                            if first_chunk:
                        ...
                        if answer_part:
                            delta_payload = {"content": answer_part}
                            if first_chunk:
                                delta_payload["role"] = "assistant"
                                first_chunk = False
                            p_ans = {
